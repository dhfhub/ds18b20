...
#define GPIO_MODER_MODER0          ((uint32_t)0x00000003)//11 模拟模式
#define GPIO_MODER_MODER0_0        ((uint32_t)0x00000001)//01 输出模式
#define GPIO_MODER_MODER0_1        ((uint32_t)0x00000002)//10 复用模式
